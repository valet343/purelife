...
class ControllerCatalogCategory extends Controller {
    ...
    // SEO URL Generator PRO . begin
		...
		if (isset($data['category_description'][$language_id]['name'])) {
			...
			$this->document->addStyle('view/stylesheet/seo_tags_generator/select2.min.css'); // SEO Tags Generator
			$this->document->addScript('view/javascript/seo_tags_generator/select2.min.js'); // SEO Tags Generator
