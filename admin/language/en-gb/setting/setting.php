...
//dc_Translates
$_['entry_social_instagram'] = 'Link to Instagram';
$_['entry_social_facebook'] = 'Link to Facebook';
$_['entry_social_twitter'] = 'Link to Twitter';
$_['entry_social_youtube'] = 'Link to Youtube';
$_['entry_social_linkedin'] = 'LinkedIn Link';
$_['entry_social_pinterest'] = 'Link to Pinterest';
$_['entry_mess_telegram'] = 'Nickname in Telegram';
$_['entry_mess_viber'] = 'Number in Viber';
$_['entry_mess_whatsapp'] = 'WhatsApp number';
$_['text_widget_fast_use'] = "Fast access";
$_['entry_widget_fast_use'] = "Display fast access widget";
$_['text_enter_admin'] = "Enter the admin panel";
$_['entry_enter_admin_after_login'] = "Page after authorization";
$_['entry_enter_admin_orders'] = "Orders";
$_['entry_enter_admin_customers'] = "Customers";
$_['entry_enter_admin_reviews'] = "Отзывы";
$_['entry_enter_admin_dashboard'] = "Status panel";
$_['text_background_login'] = "Background on the page";
$_['text_background_login_white'] = "Light";
$_['text_background_login_dark'] = "Dark";
$_['text_background_login_video']                 = "Video background";
$_['entry_cms_update'] = 'Update notification';
$_['help_cms_update'] = "Leave it on to properly display new updates for you.";
$_['text_background_login_video'] = "Videophone";
$_['entry_catalog_meta_title'] = "Autocomplete title (meta_title)";
$_['entry_catalog_meta_h1'] = "Autocomplete h1 (meta_h1)";
$_['entry_autocomplete_model'] = "Autocomplete model";
$_['entry_autocomplete_url'] = "Autocomplete URL";
$_['entry_gsnipper_status'] = "Search engine listing preview";
$_['entry_sort_new_product'] = "New products at the top of the list";
$_['help_sort_new_product'] = "For the catalog in the admin panel";
$_['entry_delete_photos_with_product'] = "Photos will be deleted when the product is removed";
$_['entry_view_product_main_category'] = "Показывать товары из подкатегорий в родельской категорий";
$_['help_view_product_main_category'] = "For the catalog on the client side";
$_['entry_zoom_product'] = "Plugin zoom image";
$_['text_price_catalog'] = "Pricing";
$_['entry_currency2'] = "Additional currency";
$_['help_currency2'] = "Displayed next to the main price in the product card";
$_['entry_autocalc_option_special'] = "Option promotion";
$_['help_autocalc_option_special'] = "The share on the option is proportional to the share on the product";
$_['entry_autocalc_option_discount'] = "Option discount";
$_['help_autocalc_option_discount'] = "Option discount is proportional to product discount";
$_['entry_autocalc_not_mul_qty'] = "Do not multiply by quantity";
$_['help_autocalc_not_mul_qty'] = "Disabling the function of multiplying by quantity";
$_['entry_autocalc_select_first'] = "Select the first option";
$_['help_autocalc_select_first'] = "Automatic selection of the first option (radio, select).";
$_['entry_autocalc_hide_option_price'] = "Don't show option price";
$_['help_autocalc_hide_option_price'] = "Hide option markup output.";
$_['entry_review_answer_admin'] = "Opportunity to answer admin";
$_['text_order']                 = "Orders";
$_['entry_order_number']                 = "Displaying the order number on the successful checkout page";
$_['text_menu']                 = "Main menu";
$_['entry_menu_size_image']                 = "Menu image size";
$_['help_menu_size_image']                 = "Size in pixels (just enter a number)";
$_['placeholder_menu_size_image']                 = "16";
$_['entry_menu_view_image']                 = "Displaying a image of the 1nd level category";
$_['entry_menu_view_image_2']                 = "Displaying a image of the 2nd level category";
$_['entry_menu_view_image_3']                 = "Displaying a image of the 3rd level category";
$_['entry_menu_view_image_4']                 = "Displaying a image of the 4th level category";
$_['entry_menu_view']                 = "How many menu levels will be displayed?";
$_['entry_logo_footer'] = "Logo for the bottom of the site";
$_['tab_catalog']                 = "Catalog";
$_['help_optimize_html_compression'] = "Compresses as much HTML code as possible for lighter weight";
$_['entry_optimize_html_compression'] = "HTML minification";
$_['help_optimize_css_compression'] = 'Compresses all CSS style files into one line for lighter weight';
$_['entry_optimize_css_compression'] = 'CSS minification';
$_['help_optimize_js_compression'] = "Compresses all JS (JQuery) scripts into one line for lighter weight";
$_['entry_optimize_js_compression'] = "JS minification";
$_['text_images'] = "Images";
$_['help_optimize_webp'] = "Sites with compressed WebP images are faster and better viewed by Google";
$_['entry_optimize_webp'] = "Images in .webp format";
$_['help_optimize_lazyload'] = 'Lazy loading images significantly improves page loading and Google Page Speed scores';
$_['help_optimize_lazyload_info'] = '<b>Standard</b> - just adds a browser tag loading="lazy"<br><b>Progressive</b> - the real image will be shown only after loading, and the place it will first display the download icon';
$_['entry_optimize_lazyload'] = "LazyLoad";
$_['text_optimize_lazyload_standard'] = "Standard";
$_['text_optimize_lazyload_progressive'] = "Progressive";
$_['help_optimize_lazyload_icon'] = 'This is an icon that will load before the actual image is shown. You can use an animated one.';
$_['help_optimize_lazyload_icon_info'] = 'You can create your own image to load on <a class="link" target="_blank" href="https://loading.io/">loading.io</a>. We recommend using animated icons';
$_['entry_optimize_lazyload_icon'] = 'Loading icon';
$_['help_meta_keyword'] = 'Google ignores the Meta (Keywords) field, you can leave it blank';
$_['column_section'] = 'Section';
$_['column_watermark'] = 'Watermark';
$_['column_webp'] = 'Convert to WebP';
$_['text_top_left'] = 'Top left corner';
$_['text_top_right'] = 'Top right corner';
$_['text_bottom_left'] = 'Bottom left corner';
$_['text_bottom_right'] = 'Bottom right corner';
...
$_['entry_zoom'] = 'Zoom';
$_['entry_image_thumb'] = 'Thumb Image';
$_['entry_image_popup'] = 'Product Popup Image';
...
$_['entry_image_option'] = 'Product Option Images';
$_['entry_image_carousel'] = 'Images in Carousel';
$_['entry_image_banner'] = 'Images in the Banner module';
$_['entry_image_slideshow'] = 'Images in the Slideshow module';
$_['entry_image_preorder'] = 'Product image for the \'Product arrival notification\' module';
$_['entry_image_p_review'] = 'Product image for the \'Product Reviews\' module';
$_['entry_watermark_see'] = 'Where to change images to .webp';