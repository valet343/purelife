...
// COMMON
$_['heading_title'] = '<span style="font-weight: 700;font-size: 10px;padding: 8px 12px;margin-right:10px;background: #e1ebf8;"><img src="../image/template_speedy_icon.svg" style="height:16px;margin-right:5px" />[Speedy]</span> Фильтр товаров';
$_['heading_title_text'] = 'Фильтр товаров';
$_['heading_title_setting'] = 'Фильтр товаров';
$_['button_apply'] = 'Применить';
$_['text_module'] = 'Модули';
$_['text_edit'] = 'Настройки фильтра товаров';
...
$_['text_ocfilter'] = 'Фильтр товаров';
