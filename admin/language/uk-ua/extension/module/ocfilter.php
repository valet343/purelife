...
// COMMON
$_['heading_title'] = '<span style="font-weight: 700;font-size: 10px;padding: 8px 12px;margin-right:10px;background: #e1ebf8;"><img src="../image/template_speedy_icon.svg" style="height:16px;margin-right:5px" />[Speedy]</span> Фiльтр товарiв';
$_['heading_title_text'] = 'Фiльтр товарiв';
$_['heading_title_setting'] = 'Фільтр товарів';
$_['button_apply'] = 'Застосувати';
$_['text_module'] = 'Модулі';
$_['text_edit'] = 'Налаштування фільтру товарів';
...
$_['text_ocfilter'] = 'Фільтр товарів';
