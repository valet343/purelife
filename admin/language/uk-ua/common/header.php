...
$_['text_support']         	 	  = 'Чат підтримки в Telegram';
...
$_['alert_after_install_devcart_pro_text']     = 'Потрібно оновити модифікатори, натисніть кнопку "Оновити"';
