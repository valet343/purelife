...
class ModelShippingUkrPoshta extends Model {
    ...
    public function creatTables() {
        ...
        $this->db->query('CREATE TABLE IF NOT EXISTS `' . DB_PREFIX . $this->extension . '_departments` (
            ...
            `IS_NODISTRICT` tinyint(1) NOT NULL,
            `RESTRICTED_ACCESS` tinyint(1) NOT NULL,
            `MRTPS` tinyint(1) NOT NULL,
   			`LONGITUDE` double NOT NULL,
   			`LATTITUDE` double NOT NULL,
            ...
            `STREET_UA` varchar(200) NOT NULL,
   			...
   			`SHORTCITYTYPE_EN` varchar(10) NOT NULL, 
   			`SHORTCITYTYPE_RU` varchar(10) NOT NULL,
   			`PDCITY_ID` int(11) NOT NULL,
   			`PDCITY_UA` varchar(100) NOT NULL,
   			`PDCITY_EN` varchar(100) NOT NULL, 
   			`PDCITY_RU` varchar(100) NOT NULL,
   			`PDOLDCITYNAME_UA` varchar(100) NOT NULL,
   			`PDOLDCITYNAME_EN` varchar(100) NOT NULL, 
   			`PDOLDCITYNAME_RU` varchar(100) NOT NULL,
   			`PDCITYTYPE_UA` varchar(20) NOT NULL,
   			`PDCITYTYPE_EN` varchar(20) NOT NULL, 
   			`PDCITYTYPE_RU` varchar(20) NOT NULL,
   			`SHORTPDCITYTYPE_UA` varchar(10) NOT NULL,
   			`SHORTPDCITYTYPE_EN` varchar(10) NOT NULL, 
   			`SHORTPDCITYTYPE_RU` varchar(10) NOT NULL,
   			`PODISTRICT_ID` int(11) NOT NULL,
   			`PDDISTRICT_ID` int(11) NOT NULL,
   			`DISTRICT_UA` varchar(50) NOT NULL,
   			`DISTRICT_EN` varchar(50) NOT NULL, 
   			`DISTRICT_RU` varchar(50) NOT NULL,
   			`NEW_DISTRICT_UA` varchar(50) NOT NULL,
   			`POREGION_ID` int(11) NOT NULL,
   			`PDREGION_ID` int(11) NOT NULL,
   			`REGION_UA` varchar(50) NOT NULL,
   			`REGION_EN` varchar(50) NOT NULL, 
   			`REGION_RU` varchar(50) NOT NULL,
   			...
   			`POLOCK_UA` varchar(50) NOT NULL,
   			`POLOCK_EN` varchar(50) NOT NULL, 
   			`POLOCK_RU` varchar(50) NOT NULL,
   			INDEX (`POCITY_ID`),
   			INDEX (`PODISTRICT_ID`),
   			INDEX (`POREGION_ID`),	
