...
class ModelLocalisationOrderStatus extends Model {
	...
	// dc_pro
	public function getOrderStatusInprocess() {
        ...
        foreach ($query->rows as $result) {
          $order_status_data[] = array(
            ...
            'name'            => $result['name'],
            'total'           => $this->model_sale_order->getTotalOrders(array('filter_order_status' => $result['order_status_id'])),
            'link'            => $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&filter_order_status=' . $result['order_status_id'], true)
          );
        }
	    return $order_status_data;
	}
