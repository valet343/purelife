...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			// dc_admin_filter_order_pm
			$data['email_url'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&filter_mail=' . $order_info['email'], true);
			$data['telephone_url'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&filter_phone=' . preg_replace('/[^0-9]/', '', $order_info['telephone']), true);
			//
